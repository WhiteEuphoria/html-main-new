...
namespace App\Models {
     ...
     * @property string|null $investment_control
     * @property string|null $beneficiary
     * @property boolean $is_default
     * @property string $currency
     * @property decimal:2 $balance
     * @property string $type
     * @property string|null $broker_initials
     * @property string|null $client_initials
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string $status
     * @property \Illuminate\Support\Carbon|null $term
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Account>|Account whereNumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Account>|Account whereOrganization($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Account>|Account whereTerm($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Account>|Account whereClientInitials($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Account>|Account whereBrokerInitials($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Account>|Account whereBeneficiary($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Account>|Account whereInvestmentControl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Account>|Account whereBank($value)
    ...
    /**
     * App\Models\BrokerAccount
     *
     * @method static \Illuminate\Database\Eloquent\Builder<BrokerAccount>|BrokerAccount newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<BrokerAccount>|BrokerAccount newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<BrokerAccount>|BrokerAccount query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class BrokerAccount extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\DashboardSetting
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     ...
     * @property string $key
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<DashboardSetting>|DashboardSetting whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DashboardSetting>|DashboardSetting whereKey($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DashboardSetting>|DashboardSetting whereValue($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DashboardSetting>|DashboardSetting whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DashboardSetting>|DashboardSetting whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DashboardSetting>|DashboardSetting whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DashboardSetting>|DashboardSetting newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<DashboardSetting>|DashboardSetting newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<DashboardSetting>|DashboardSetting query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class DashboardSetting extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Document>|Document whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Document>|Document wherePath($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Document>|Document whereOriginalName($value)
     ...
     * @property int $id
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder<FraudClaim>|FraudClaim whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FraudClaim>|FraudClaim whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FraudClaim>|FraudClaim whereDetails($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FraudClaim>|FraudClaim whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FraudClaim>|FraudClaim whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FraudClaim>|FraudClaim whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FraudClaim>|FraudClaim newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<FraudClaim>|FraudClaim newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<FraudClaim>|FraudClaim query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class FraudClaim extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<SupportMessage>|SupportMessage whereDirection($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Transaction>|Transaction whereFrom($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Transaction>|Transaction whereTo($value)
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Account> $brokerageAccounts
     * @property-read int|null $brokerageAccounts_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Account> $transitAccounts
     * @property-read int|null $transitAccounts_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\FraudClaim> $fraudClaims
     * @property-read int|null $fraudClaims_count
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\SupportMessage> $supportMessages
     * @property-read int|null $supportMessages_count
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereVerificationStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereMainBalance($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Withdrawal>|Withdrawal whereRequisites($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Withdrawal>|Withdrawal whereMethod($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Withdrawal>|Withdrawal whereFromAccountId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Withdrawal>|Withdrawal whereApplied($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Withdrawal>|Withdrawal whereAppliedAt($value)
